...
<link rel="stylesheet" type="text/css" href="${ pageContext.request.contextPath }/resources/css/vendors.min.css">
  ...
  <link rel="stylesheet" type="text/css" href="${ pageContext.request.contextPath }/resources/css/dark-layout.css">
    ...
    <!-- BEGIN: Page CSS-->
    <link rel="stylesheet" type="text/css" href="${ pageContext.request.contextPath }/resources/css/horizontal-menu.css">
                        ...
                        <div class="card bg-authentication rounded-0 mb-0">
                            <div class="row m-0">
                                <div class="col-lg-6 d-lg-block d-none text-center align-self-center px-1 py-0">
                                    <img src="${ pageContext.request.contextPath }/resources/images/login.png" alt="branding logo">
                                </div>
                                        ...
                                        <div class="card-content">
                                            <div class="card-body pt-1">
                                                <form action="index.html">
                                                    ...
                                                    <a href="${ pageContext.request.contextPath }/member/join" class="btn btn-outline-primary float-left btn-inline">회원가입</a>
