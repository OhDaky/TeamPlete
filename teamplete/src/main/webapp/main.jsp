	...
	<div class="col-md-6 col-sm-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Teamplete에 오신 걸 환영합니다</h4>
                                </div>
                                <div class="card-content">
                                    <div class="card-body">
                                        <div id="carousel-example-caption" class="carousel slide" data-ride="carousel">
                                            ...
                                            <div class="carousel-inner" role="listbox">
                                                <div class="carousel-item active">
                                                    <img class="img-fluid" src="${ pageContext.request.contextPath }/resources/images/04.jpg" alt="First slide">
                                                    <div class="carousel-caption">
                                                        <h3>팀플리트에 오신 걸 환영합니다</h3>
                                                        <p>Welcome to Teamplete</p>
                                                    </div>
                                                </div>
                                                <div class="carousel-item">
                                                    <img class="img-fluid" src="${ pageContext.request.contextPath }/resources/images/06.jpg" alt="Second slide">
                                                    <div class="carousel-caption">
                                                        <h3>팀플리트에 오신 걸 환영합니다</h3>
                                                        <p>Welcome to Teamplete/p>
                                                    </div>
                                                ...
                                                <div class="carousel-item">
                                                    <img class="img-fluid" src="${ pageContext.request.contextPath }/resources/images/05.jpg" alt="Third slide">
                                                    <div class="carousel-caption">
                                                        <h3>팀플리트에 오신 걸 환영합니다</h3>
                                                        <p>Welcome to Teamplete</p>
                                                    </div>
